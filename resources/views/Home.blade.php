                        ...
                        <div class="d-flex justify-content-end align-items-center col-12">
                            ...
                            <div class="row justify-content-end align-items-center ">
                                ...
                                <div class="d-flex justify-content-end align-items-center col-4">
                                    <div class="pic">
                                        <input type="file" id="pic" name="pic" class="dropify" accept=".pdf,.jpg, .png, image/jpeg, image/png"
                                               data-height="70"/>
                                    </div>
                                    <div>
                                        <label id="fileLabel" for="pic">Choose File</label>
                                        <div id="imagePreview" name="imagePreview"><img src="{{route('index')}} "></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-8">
                                    ...
                                    <div class="form-group col-12 ">
                                        <input type="text" class="form-control text-end bg-light btn-outline-dark" id="code_sub" name="code_sub"
                                               placeholder="رمز المورد">
                                    </div>

                                    <div class="form-group col-12 ">
                                        <input type="text" class="form-control text-end bg-secondary-subtle btn-outline-dark " id="name_sub" name="name_sub"
